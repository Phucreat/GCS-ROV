...
def run_tests():
    ...
    out, action = brain.process_pilot_input("bật đèn rọi 100%", telemetry)
    ...
    out2, action2 = brain.process_pilot_input("ngắt động cơ khẩn cấp", telemetry)
    ...
    out3, action3 = brain.process_pilot_input("xác nhận", telemetry)
    ...
    out4, _ = brain.process_pilot_input("cho tôi biết quy trình kiểm tra đường ống", telemetry)
