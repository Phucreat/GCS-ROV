...
<div class="page-sheet">
    ...
    <div class="page-body">
        ...
        <div class="faq-box">
            ...
            <div class="faq-a">
                Bạn có thể kiểm tra rất dễ dàng bằng 2 cách: (1) Nhìn tiêu đề trên thanh cửa sổ ứng dụng: hiển thị chữ <strong>"CNC NExora GCS - v1.1.0"</strong>; hoặc (2) Mở ⚙️ Cài đặt &rarr; Tab "🔄 Cập nhật" để xem nhãn <em>"Phiên bản hiện tại: v1.1.0"</em>.
            </div>
        </div>
